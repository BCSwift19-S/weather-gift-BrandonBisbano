        ...
        Alamofire.request(alamoURL).responseJSON { response in
            ...
            case .success(let value):
                ...
                for hour in 1...hours {
                    ...
                    let hourlyPrecipType = json["hourly"]["data"][hour]["precipType"].stringValue
                    let newHourlyForecast = HourlyForecast(hourlyTime: hourlyTime, hourlyTemperature: hourlyTemperature, hourlyPrecipProb: hourlyPrecipProb, hourlyIcon: hourlyIcon, hourlyPrecipType: hourlyPrecipType)
